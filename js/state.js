...
const State = (() => {
  ...
  const navConfig = {
    student: [
      ...
      { id:'stu-attendance',  label:'Attendance',         icon:'✅' },
      { id:'grades',          label:'My Grades',          icon:'📊' },
      { section:'Communication' },
      { id:'notif-center',     label:'Notifications',      icon:'🔔' },
      { id:'messages',         label:'Messages',           icon:'✉️' },
      { id:'stu-docs',         label:'My Documents',       icon:'📑' },
      { id:'announcements',   label:'Announcements',      icon:'📢' },
      { id:'chat',            label:'Chat Rooms',         icon:'💬' },
      { id:'reviews',         label:'Reviews',            icon:'⭐' },
      { section:'Support' },
      { id:'counseling',       label:'Counseling & Wellbeing', icon:'🧠' },
      { section:'AI' },
    ...
    facilitator: [
      { section:'Teaching' },
      { id:'dashboard',       label:'Dashboard',          icon:'🏠' },
      { id:'timetable',       label:'My Schedule',        icon:'🗓️' },
      { id:'fac-materials',   label:'Learning Materials', icon:'📄' },
      { id:'attendance',      label:'Attendance',         icon:'✅' },
      { id:'fac-assignments', label:'Assignments',        icon:'📌' },
    ...
    'uni-admin': [
      ...
      { id:'doc-requests',  label:'Document Requests',  icon:'📜' },
      { id:'counseling',    label:'Counseling & Wellbeing', icon:'🧠' },
      { id:'announcements', label:'Announcements',      icon:'📢' },
      { section:'Reports' },
      { id:'analytics',     label:'Operations Overview',icon:'📈' },
      { section:'Platform' },
    ...
    'super-admin': [
      { section:'System' },
      { id:'dashboard',    label:'Dashboard',          icon:'🏠' },
      { id:'sys-log',      label:'System Log',         icon:'📋' },
      { section:'Platform' },
